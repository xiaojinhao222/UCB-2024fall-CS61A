...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy_roll_n(score0, score1):
        return n
    return strategy_roll_n
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    for roll in range(1, 11):
        one_dice = make_averaged(roll_dice, samples_count)
        sum_roll = one_dice(roll, dice)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    goal=100
    def can_win(dice_to_roll):
        return score + roll_dice(dice_to_roll, six_sided) >= 100
    # 1.检查是否需要0，1，2
    if can_win(1):
        return 1
    elif can_win(2):
        return 2
    elif sus_points(score) >= 100:
        return 0
    # 2.如果领先
    if score > opponent_score:
        return 3
    # 3.判断是6还是0
    return sus_strategy(score, opponent_score, roll_dice(6), num_rolls = 6)
    # END PROBLEM 12
